 ...
 */
function getConversationByChannelId(req, res, next) {
    Conversation.find({ channelId: req.channelId })
...
export default { getConversationByChannelId, get, create, createMessage }